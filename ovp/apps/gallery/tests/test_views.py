...
class GalleryViewSetTestCase(TestCase):
  ...
  def test_can_create_gallery(self):
    data = {"name": "test", "description": "abc123", "images": [{"id": self.img1.pk}]}
  ...
  def test_can_edit_gallery(self):
    data = {"name": "test2", "description": "edited", "images": [{"id": self.img2.pk}]}
  ...
  def test_can_edit_project_gallery(self):
    # This tests galleries that are associated with a Project.post or Project
    # Other users in the organization should be allowed to edit them
    self.test_can_create_gallery()
    gallery = Gallery.objects.last()
    uuid_str = str(gallery.uuid)

    user1 = User.objects.create(email="test-project-owner@gmail.com", password="test1", object_channel="default")
    user2 = User.objects.create(email="test-organization-owner@gmail.com", password="test1", object_channel="default")
    user3 = User.objects.create(email="test-organization-member@gmail.com", password="test1", object_channel="default")
    org = Organization.objects.create(name="test organization", owner=user2, object_channel="default")
    org.members.add(user3)
    org.save()
    project = Project.objects.create(name="test project", owner=user1, organization=org, object_channel="default")
    ...
    post = Post.objects.create(content="tst", user=user1, gallery=gallery, object_channel="default")
  ...
  def _test_permissions_multiple_users(self, project_owner, organization_owner, organization_member, uuid_str):
    data = {"name": "test2", "description": "edited", "images": [{"id": self.img2.pk}]}
