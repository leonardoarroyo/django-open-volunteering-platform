...
class UploadedImageViewSetTestCase(TestCase):
  ...
  def test_cant_upload_no_image(self):
    ...
    user = get_user_model().objects.create_user('test_cant_upload_no_image@test.com', 'validpassword', object_channel="default")
  ...
  def test_can_upload_authenticated(self):
    ...
    user = get_user_model().objects.create_user('test_can_upload@test.com', 'validpassword', object_channel="default")
