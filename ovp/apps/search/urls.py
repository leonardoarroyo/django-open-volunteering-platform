...
project_search.register(r'projects/map-data', views.ProjectMapDataResource, 'search-projects-map-data')
...
project_search.register(r'organizations/map-data', views.OrganizationMapDataResource, 'search-organizations-map-data')
