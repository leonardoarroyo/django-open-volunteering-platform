...
class SalesForceTest(TestCase):
    ...
    @mock.patch('ovp.apps.salesforce.tasks.create_contact')
    ...
    #test_publishing_organization_triggers_triggers_task
    #test_task_create_organization
    #test_task_update_organization_if_exists
