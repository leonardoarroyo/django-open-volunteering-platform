...
class OrganizationMail(BaseMail):
    ...
    def sendUserInvited(self, context={}):
        ...
        if organization.owner == context['invite'].invitator:
            ...
            self.__init__(
                organization,
                async_mail=self.async_mail,
                override_receiver=invitator.email,
                locale=invitator.locale)
            self.sendEmail(
                'userInvited-toMemberInviter',
    ...
    def sendUserLeft(self, context={}):
        ...
        self.__init__(
            ...
            async_mail=self.async_mail,
            override_receiver=context['user'].email,
        ...
        self.__init__(
            context['organization'],
            async_mail=self.async_mail,
            override_receiver=context['organization'].owner.email,
            locale=context['organization'].owner.locale)
        self.sendEmail(
            'userLeft-toOwner',
